...
public class BlockOreBase extends BlockBasic {
	...
	public BlockOreBase(String name, Material material, Item toDrop) {
		this(name, material, toDrop, 3, 6);
	}
	
	public BlockOreBase(String name, Material material, Item toDrop, int dropAmount) {
		this(name, material, toDrop, dropAmount, dropAmount);
	}
	
	public BlockOreBase(String name, Material material, Item toDrop, int minDropAmount, int maxDropAmount) {
		super(name,material);
		this.toDrop = toDrop;
