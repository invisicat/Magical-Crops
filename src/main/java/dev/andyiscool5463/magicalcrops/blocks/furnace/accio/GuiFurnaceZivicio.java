...
public class GuiFurnaceZivicio extends GuiContainer{
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":" + "textures/gui/container/zivicio_furnace_gui.png");
	private final InventoryPlayer player;
	private final TileEntityFurnaceZivicio tileentity;
	
	public GuiFurnaceZivicio(InventoryPlayer player, TileEntityFurnaceZivicio tileentity) {
		super(new ContainerFurnaceZivicio(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityFurnaceZivicio.isBurning(this.tileentity)) {
