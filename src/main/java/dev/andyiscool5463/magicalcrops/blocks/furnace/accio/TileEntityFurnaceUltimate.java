...
public class TileEntityFurnaceUltimate extends TileEntity implements IInventory, ITickable, ISidedInventory {
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.furnace_ultimate";
	}
	...
	public void update() {
		...
		if(!this.world.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				BlockFurnaceUltimate.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	public void smeltItem() {
		if(this.canSmelt()) {
			...
			ItemStack result = FurnaceRecipes.instance().getSmeltingResult(input1);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	public String getGuiID() {
		return "magicalcrops:furnace_ultimate";
	}
