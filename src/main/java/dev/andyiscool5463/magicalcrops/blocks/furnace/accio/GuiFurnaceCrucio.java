...
public class GuiFurnaceCrucio extends GuiContainer{
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":" + "textures/gui/container/crucio_furnace_gui.png");
	private final InventoryPlayer player;
	private final TileEntityFurnaceCrucio tileentity;
	
	public GuiFurnaceCrucio(InventoryPlayer player, TileEntityFurnaceCrucio tileentity) {
		super(new ContainerFurnaceCrucio(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityFurnaceCrucio.isBurning(this.tileentity)) {
