...
public class TileEntityFurnaceImperio extends TileEntity implements IInventory, ITickable,ISidedInventory{
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.furnace_imperio";
	}
	...
	public void update() {
		...
		if(!this.world.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				BlockFurnaceImperio.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	public String getGuiID() {
		return "magicalcrops:furnace_imperio";
	}
