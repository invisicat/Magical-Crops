...
public class TileEntityFurnaceZivicio extends TileEntity implements IInventory, ITickable{
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "container.furnace_zivicio";
	}
	...
	public void update() {
		...
		if(!this.world.isRemote) {
			...
			if(flag != this.isBurning()) {
				flag1 = true;
				BlockFurnaceZivicio.setState(this.isBurning(), this.world, this.pos);
			}
		} if(flag1)
			this.markDirty();
	}
	...
	public String getGuiID() {
		return "magicalcrops:furnace_zivicio";
	}
