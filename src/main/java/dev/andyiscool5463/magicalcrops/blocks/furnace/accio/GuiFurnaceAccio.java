...
public class GuiFurnaceAccio extends GuiContainer{
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":" + "textures/gui/container/accio_furnace_gui.png");
	private final InventoryPlayer player;
	private final TileEntityFurnaceAccio tileentity;
	
	public GuiFurnaceAccio(InventoryPlayer player, TileEntityFurnaceAccio tileentity) {
		super(new ContainerFurnaceAccio(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityFurnaceAccio.isBurning(this.tileentity)) {
