...
public class ContainerFurnaceCrucio extends Container {
	...
	public ContainerFurnaceCrucio(InventoryPlayer player, TileEntityFurnaceCrucio tileentity) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int slotIndex) {
		...
		if(slot != null && slot.getHasStack()) { // this checks to make sure the slot isnt null or empty
			...
			if(slotIndex == OUTPUT) { // if the slot is the output
				...
				} else if(TileEntityFurnaceCrucio.isItemFuel(itemStack2)) {
