...
public class GuiFurnaceUltimate extends GuiContainer{
	
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":" + "textures/gui/container/ultimate_furnace_gui.png");
	private final InventoryPlayer player;
	private final TileEntityFurnaceUltimate tileentity;
	
	public GuiFurnaceUltimate(InventoryPlayer player, TileEntityFurnaceUltimate tileentity) {
		super(new ContainerFurnaceUltimate(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		if(TileEntityFurnaceUltimate.isBurning(this.tileentity)) {
